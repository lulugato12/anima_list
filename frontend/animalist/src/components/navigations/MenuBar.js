...
import './MenuBar.css'
import { Row, Col, Form, FormControl, Button, Container, Navbar, Nav, NavDropdown } from 'react-bootstrap'
                    ...
                    <Row className='nav2'>
                        <Col md="auto">
                            <Navbar.Collapse id="basic-navbar-nav">
                                <Nav>
                                    <Navbar.Brand className='logo' href="/">Animalist</Navbar.Brand>
                    ...
                    <Row className='nav2'>
                        <Col>
                            <Form className="d-flex">
                                <FormControl type="search" placeholder="Search Anime, Movie or OVA" className="me-2" aria-label="Search"/>
